# Generated by Django 4.2 on 2023-04-07 22:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("awaiting_offer", "Registered and waiting for a group"),
                            ("group_offered", "Was offered a group, has not responded yet"),
                            ("awaiting_start", "Group confirmed, awaiting start of classes"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("active", "Completed registration in the bot"),
                            ("on_leave", "On leave"),
                            ("no_response", "Not responding"),
                            (
                                "left_prematurely",
        ...
        migrations.AddField(
            model_name="teacher",
            name="non_teaching_help_types_provided",
            field=models.ManyToManyField(
                blank=True,
                related_name="teachers",
                to="api.nonteachinghelptype",
        ...
        migrations.AddField(
            model_name="student",
            name="non_teaching_help_types_required",
            field=models.ManyToManyField(
                blank=True,
