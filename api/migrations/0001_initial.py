# Generated by Django 5.0.3 on 2024-05-01 13:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("chatwoot_conversation_id", models.PositiveIntegerField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "legacy_gid",
                    models.IntegerField(help_text="Group id from the old database", null=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "legacy_cid",
                    models.IntegerField(
                        help_text="Coordinator id from the old database", null=True
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "legacy_sid",
                    models.IntegerField(help_text="Student id from the old database", null=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "legacy_tid",
                    models.IntegerField(help_text="Teacher id from the old database", null=True),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("no_group_yet", "Not working, waiting for a group"),
                            ("working", "Working"),
                            ("on_leave", "On leave"),
                            (
                                "left_prematurely",
        ...
        migrations.AddConstraint(
            model_name="coordinator",
            constraint=models.UniqueConstraint(fields=("legacy_cid",), name="legacy_cid"),
        ),
        migrations.AddIndex(
            model_name="studentlogevent",
        ...
        migrations.AddConstraint(
            model_name="student",
            constraint=models.UniqueConstraint(fields=("legacy_sid",), name="legacy_sid"),
        ),
        migrations.AddIndex(
            model_name="teacherlogevent",
        ...
        migrations.AddConstraint(
            model_name="teacher",
            constraint=models.UniqueConstraint(fields=("legacy_tid",), name="legacy_tid"),
        ),
        migrations.AddIndex(
            model_name="group",
        ...
        migrations.AddConstraint(
            model_name="group",
            constraint=models.UniqueConstraint(fields=("legacy_gid",), name="legacy_gid"),
        ),
        migrations.AddConstraint(
            model_name="group",
            constraint=models.UniqueConstraint(
