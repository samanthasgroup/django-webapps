...
class PersonalInfo(GroupOrPerson):
    ...
    # to prevent IDOR
    uuid = models.UUIDField(verbose_name=_("autogenerated unique identifier"), default=uuid.uuid4, editable=False)
    # Automatically save date and time when the Person was created.
    date_and_time_added = models.DateTimeField(verbose_name=_("Date and time added"), auto_now_add=True)
    ...
    telegram_username = models.CharField(verbose_name=_("Telegram username"), max_length=100, blank=True)
    ...
    class Meta:
        ...
        constraints = [models.UniqueConstraint(fields=["first_name", "last_name", "email"], name="full_name_and_email")]
        indexes = [models.Index(fields=("last_name", "first_name", "email"), name="name_email_idx")]
