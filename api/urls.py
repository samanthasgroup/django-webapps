...
internal_router.register(r"languages_and_levels", LanguageAndLevelViewSet, basename="languages_and_levels")
internal_router.register(r"day_and_time_slots", DayAndTimeSlotViewSet, basename="day_and_time_slots")
internal_router.register(r"enrollment_test", EnrollmentTestViewSet, basename="enrollment_test")
internal_router.register(r"enrollment_test_result", EnrollmentTestResultViewSet, basename="enrollment_test_result")
internal_router.register(r"non_teaching_help", NonTeachingHelpViewSet, basename="non_teaching_help")
...
dashboard_router.register(r"languages_and_levels", DashboardLanguageAndLevelViewSet, basename="languages_and_levels")
dashboard_router.register(r"day_and_time_slots", DashboardDayAndTimeSlotViewSet, basename="day_and_time_slots")
